                    ...
                    <div class="md:grid md:grid-cols-3 md:gap-6">
                        <div class="md:col-span-1">
                            <div class="px-4 sm:px-0">
                                <h3 class="text-lg font-medium leading-6 text-gray-900">Create Countries</h3>
                            </div>
                        </div>
                                                    ...
                                                    @forelse ($country->states as $state)
                                                        <tr>
                                                            ...
                                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                                <a href="{{route('admin.states.edit', $state->id)}}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                                                <form method="POST" action="{{ route('admin.states.destroy',$state->id) }}">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <a class="text-red-600 hover:text-red-900" 
                                                                            href="{{ route('admin.states.destroy',$state->id) }}" onclick="event.preventDefault(); this.closest('form').submit();">
                                                                        Delete
                                                                    </a>
                                                                </form>
                                                            </td>
